# Contributing to phrasePop

First off, thank you for considering contributing to phrasePop! It's people like you that make phrasePop such a great tool for the community.

## Local Development Setup

phrasePop is built using **Tauri 2**, **Rust**, **React**, and **TypeScript**. You'll need Node.js and the Rust toolchain installed.
